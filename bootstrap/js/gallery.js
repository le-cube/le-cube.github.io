...
$(function() {
    ...
    Gallery = (function() {
        ...
        init            = function() {
            ...
            $items.add('<img src="'+siteImgPath+'ajax-loader.gif"/><img src="'+siteImgPath+'black.png"/>').imagesLoaded( function() {
                // add options
                //_addViewModes();
        ...
        _showImage        = function( $item ) {
            ...
            var curObj      = EFGallery;
            var curImg      = curObj.images[id];
...
*/
            ...
            var imgSrc  = EFGalleryImagesPath + curImg;
            var imgAlt  = curObj['title'];

            var legende     = curObj["legende"] ? '<br>' + curObj["legende"] : "";

            var imgLegend   = '<a href="#" class="legendTogle"><small>légende</small></a>';

            var imgCaption  = '<strong>' + curObj["nom"] + '</strong>' + legende;
